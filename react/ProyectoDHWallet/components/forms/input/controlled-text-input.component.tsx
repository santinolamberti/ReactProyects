...
const ControlledTextInput: FC<ControlledTextInputProps> = ({isNotGrid, width, name, placeholder, defaultValue, type, id, onFocus, handleChangeCustom, onKeyPress}: ControlledTextInputProps) => {
	...
	return (
		<Grid item mobile={width}>
			<TextField
				...
				type={type}
				placeholder={placeholder}
				sx={{backgroundColor: 'secondary.light', borderRadius: '10px', border: 'none'}}
				fullWidth
				inputProps={{
					autoComplete: 'off'
				 }}
