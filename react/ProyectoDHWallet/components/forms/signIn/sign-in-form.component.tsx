    ...
    <Stack component="form" autoComplete="off" width={mobile ? '90%' : laptopOrDesktop ? '70%': '90%'} height={'100%'} padding={'10px 0 20px'} onSubmit={(e:React.FormEvent) => { e.preventDefault()}}> 
          ...
          <Grid container rowSpacing={{ mobile: 3, tablet: 3}} columnSpacing={{ mobile: 1, tablet: 5}}>
            <FormProvider {...methods}>
                <ControlledTextInput name="firstName" placeholder="Nombre*" type="text" width={mobile ? 12 : 6}/>
                <ControlledTextInput name="lastName" placeholder="Apellido*" type="text" width={mobile ? 12 : 6}/>
                <ControlledTextInput name="dni" placeholder="DNI*" type="number" width={mobile ? 12 : 6}/>
                <ControlledTextInput name="email" placeholder="Email*" type="text" width={mobile ? 12 : 6}/>
                <Grid item mobile={12}>
                ...
                <ControlledTextInput name="password" placeholder="Contraseña*" type="password" width={mobile ? 12 : 6}/>
                <ControlledTextInput name="repassword" placeholder="Confirmar contraseña*" type="password" width={mobile ? 12 : 6}/>
                <ControlledTextInput name="phone" placeholder="Teléfono*" type="number" width={mobile ? 12 : 6}/>
            </FormProvider>
