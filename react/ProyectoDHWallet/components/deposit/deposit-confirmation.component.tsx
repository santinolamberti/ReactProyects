...
import { POST_DEPOSIT } from 'api/api';
...
export const DepositConfirmation: FC<DepositConfirmationProps> = ({page}: DepositConfirmationProps) => {
    ...
    return (
            ...
            <>
                ...
                {mobile && 
                <Box sx={{display: 'flex', width: '90%', justifyContent: 'end', alignItems: 'center'}}>
                ...
                {error.length > 0 && 
                <Typography width={'90%'} textAlign='center' variant='body1' color='error'>Error al realizar la transferencia. Inténtelo de nuevo más tarde.</Typography>
                }
