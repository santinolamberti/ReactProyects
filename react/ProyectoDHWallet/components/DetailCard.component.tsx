                ...
                >
                    <Box width={'100%'} sx={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            ...
                            <div>
                                <Typography color='secondary.light' sx={{ fontSize: '16px' }}>{`${transaction?.type === 'Deposit' ? 'Depósito:' : 'Extracción:'}`}</Typography>
                                <Typography color='secondary' variant={'h4'}>{`${transaction?.destination ? transaction?.destination : 'Cuenta Propia DMH'}`}</Typography>
                            </div>
                            <div>
