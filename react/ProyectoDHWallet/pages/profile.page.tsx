...
import { Box, useMediaQuery, Button, Stack, Grid, Alert } from '@mui/material';
            ...
            >
                ...
                <Box sx={{display: 'flex', justifyContent: 'end', alignItems: 'center'}}>
                        ...
                        <Grid container columnSpacing={1} justifyContent='end' width={mobile ? '35%': laptopOrDesktop ? '23%' : '25%'} >
                            ...
                            <Grid item mobile={6}>
                                <Button variant="contained" color="secondary" size="small" onClick={() => editData()} sx={{minWidth: '30px'}} fullWidth>
