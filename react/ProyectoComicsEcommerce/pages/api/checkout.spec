...
//             const order = {usuario: {entrega: {}}, tarjeta: {nroTarjeta: validCard}} as CheckoutInput
...
//             const {req, res} = createMocks({
//                 method: 'POST',
//                 body: {usuario: {entrega: {departamento: invalidAddress}}} as CheckoutInput
//             });
//             await handleCheckout(req, res);
...
//             const {req, res} = createMocks({
//                 method: 'POST',
//                 body: {usuario: {entrega: {}}, tarjeta: {nroTarjeta: withoutFundsCard}} as CheckoutInput
//             });
//             await handleCheckout(req, res);
//             expect(res._getStatusCode()).toBe(400)
//             expect(JSON.parse(res._getData())).toEqual(
...
//             const {req, res} = createMocks({
//                 method: 'POST',
//                 body: {usuario: {entrega: {}}, tarjeta: {nroTarjeta: withoutAuthorizationCard}} as CheckoutInput
//             });
//             await handleCheckout(req, res);
//             expect(res._getStatusCode()).toBe(400)
//             expect(JSON.parse(res._getData())).toEqual(
...
//             const {req, res} = createMocks({
//                 method: 'POST',
//                 body: {usuario: {entrega: {}}, tarjeta: {nroTarjeta: '4111'}} as CheckoutInput
//             });
//             await handleCheckout(req, res);
//             expect(res._getStatusCode()).toBe(400)
//             expect(JSON.parse(res._getData())).toEqual(
